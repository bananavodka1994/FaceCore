        ...
        struct npc_og_mekkatorqueAI : public npc_escortAI
        {
            ...
            void SpecialKill(uint32 variation)
            {
                switch (variation)
                {
                        ...
                        if (uiStep > 14)
                        {
                            switch (uiRLDestroyed)
                            {
                                ...
                                case 4:
                                    break;
                                default:
                                    TC_LOG_INFO(LOG_FILTER_GENERAL, "More than 4 Rocket Launchers destroyed!");
                            }
                        }
                        break;
                    case 1:
                    ...
                    case 3:
                        ...
                        break;
                    default:
                        TC_LOG_ERROR(LOG_FILTER_SQL, "Unexpected variation (%i) in npc_og_mekkatorqueAI::SpecialKill call!", variation);
                }
            }
            ...
            void DoPlayMusic(uint8 musicId)
            {
                switch (musicId)
                {
                    ...
                    case 2:
                        ...
                        break;
                    default:
                        TC_LOG_ERROR(LOG_FILTER_SQL, "Unexpected musicId (%i) in npc_og_mekkatorqueAI::DoPlayMusic call!", musicId);
                }
            }
            ...
            void UpdateBannerState(float radius)
            {
                ...
                if (!BannerList_temp.empty())
                {
                    ...
                    TC_LOG_ERROR(LOG_FILTER_SQL, "TSCR error: BannerList is empty!");
            }
